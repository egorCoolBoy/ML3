...
> ## Термины и пояснения
> - **Итерация** — все работы до старта инвесторского демо (целевая дата: 30 мая).
...
1. Рабочее демо на 30 мая: агент **между двумя сессиями** вспоминает факт из прошлого диалога и **проактивно** поднимает его (референсный сценарий CEO: «сын в 9-м классе → спросил про экзамены»).
...
4. Инвесторское демо 30 мая — офлайн/онлайн сценарий с заранее «свежим» тестовым пользователем (не разработчиком).
